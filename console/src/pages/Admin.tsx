...
export function AdminPage() {
  ...
  async function onCreate(e: FormEvent) {
    ...
    try {
      ...
      setNotice(`Created ${created.name}. Invite an owner so they can open it in the organization app.`);
      await load();
    } catch (err) {
  ...
  async function onInvite(e: FormEvent) {
    ...
    try {
      ...
      setInviteEmail("");
      setNotice(`Invited ${inviteEmail} as owner. They sign in on the organization frontend.`);
    } catch (err) {
  ...
  return (
    <div>
      <PageHeader
        eyebrow="Platform"
        title="Organizations"
        description="Create tenants, invite the first owner, and suspend orgs. Usage is last 7 days of SDK events. Owners manage projects in the organization frontend."
      />
