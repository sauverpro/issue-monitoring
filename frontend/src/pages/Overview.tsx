...
export function Overview() {
  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 bg-gradient-to-r from-zinc-50 dark:from-zinc-900 via-zinc-50/90 dark:via-zinc-900/90 to-white dark:to-zinc-950 p-6 shadow-2xl ring-1 ring-zinc-950/5 dark:ring-white/[0.04]">
        ...
        <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div
                className={clsx(
                  ...
                  sse.connected
                    ? "border-emerald-500/30 bg-emerald-500/15 text-emerald-700 dark:text-emerald-300 shadow-sm shadow-emerald-500/20"
                    : sse.reconnecting
                      ? "border-amber-500/30 bg-amber-500/15 text-amber-700 dark:text-amber-300 shadow-sm shadow-amber-500/20"
                      : "border-zinc-300 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-900 text-zinc-700 dark:text-zinc-400"
                )}
              >
                <Radio
                  className={clsx(
                    "h-3.5 w-3.5",
                    sse.connected && "text-emerald-600 dark:text-emerald-400 animate-pulse",
                    sse.reconnecting && "text-amber-600 dark:text-amber-400 animate-bounce"
                  )}
                />
          ...
          <div className="flex flex-col items-start gap-2 lg:items-end">
            ...
            <div className="inline-flex rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white/80 dark:bg-zinc-950/80 p-1.5 ring-1 ring-zinc-950/5 dark:ring-white/[0.04]">
              {WINDOWS.map((w) => {
                  ...
                  <button
                    ...
                    className={clsx(
                      ...
                      isActive
                        ...
                        : "text-zinc-700 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white hover:bg-zinc-200/60 dark:hover:bg-zinc-800/60"
                    )}
                  >
                    {w.label}
                  </button>
        ...
        <div className="mt-6 flex flex-wrap items-center justify-between gap-4 rounded-xl border border-zinc-200/90 dark:border-zinc-800/90 bg-white/70 dark:bg-zinc-950/70 p-4">
          ...
          <div className="flex items-center gap-4 text-xs">
            <div className="text-right">
              <span className="block text-zinc-600 dark:text-zinc-500 text-[10px] uppercase font-semibold">Window Success</span>
            ...
            <div className="text-right">
              <span className="block text-zinc-600 dark:text-zinc-500 text-[10px] uppercase font-semibold">Total Calls ({windowId})</span>
      ...
      <details className="group overflow-hidden rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 bg-zinc-50/40 dark:bg-zinc-900/40 transition-colors open:bg-zinc-50/60 dark:open:bg-zinc-900/60">
        <summary className="flex cursor-pointer list-none items-center justify-between gap-3 p-4 select-none">
          ...
          <ChevronDown className="h-4 w-4 shrink-0 text-zinc-600 dark:text-zinc-500 transition-transform duration-200 group-open:rotate-180" />
        </summary>

        <div className="space-y-5 border-t border-zinc-200/80 dark:border-zinc-800/80 p-5 text-sm text-zinc-700 dark:text-zinc-400">
          <div>
            <h3 className="mb-1 flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-zinc-600 dark:text-zinc-300">
            ...
            <p className="leading-relaxed">
              ...
              <span className="font-semibold text-amber-700 dark:text-amber-300">other</span> (network/timeout)
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            <div>
              <h3 className="mb-1.5 text-xs font-bold uppercase tracking-wider text-zinc-600 dark:text-zinc-300">
                Status colors
              </h3>
            ...
            <div>
              ...
              <dl className="space-y-1.5">
                <div>
                  <dt className="inline font-semibold text-zinc-700 dark:text-zinc-200">P50 (median):</dt>{" "}
                  <dd className="inline">half of all requests finished faster than this.</dd>
                </div>
                <div>
                  <dt className="inline font-semibold text-zinc-700 dark:text-zinc-200">P95 (tail):</dt>{" "}
                  <dd className="inline">
                ...
                <div>
                  <dt className="inline font-semibold text-zinc-700 dark:text-zinc-200">Error rate:</dt>{" "}
                  <dd className="inline">
                    share of calls that returned a failure or non-2xx response.
                  </dd>
                </div>
                <div>
                  <dt className="inline font-semibold text-zinc-700 dark:text-zinc-200">Open incidents:</dt>{" "}
                  <dd className="inline">
          ...
          <div>
            ...
            <ol className="space-y-1.5 list-decimal list-inside leading-relaxed">
              ...
              <li>
                ...
                Slack is notified if configured.
              </li>
              <li>
                A recovery job auto-resolves incidents once the rate stays below 5% for two consecutive
                5-minute checks.
              </li>
              <li>
                Synthetic pings and the public{" "}
                <Link to="/status" className="font-medium text-emerald-600 dark:text-emerald-400 hover:underline">
                  status page
                </Link>{" "}
                provide independent uptime visibility.
              </li>
            </ol>
          </div>
          ...
          <div>
            ...
            <ul className="grid gap-1.5 sm:grid-cols-2">
              <li>
                <Link to="/incidents" className="font-medium text-emerald-600 dark:text-emerald-400 hover:underline">
                  Incidents
                </Link>{" "}
                — investigate active or past error-rate breaches.
              </li>
              <li>
                <Link to="/events" className="font-medium text-emerald-600 dark:text-emerald-400 hover:underline">
                  Event log
                </Link>{" "}
                — see every individual raw API call recorded.
              </li>
              <li>
                <Link to="/endpoints" className="font-medium text-emerald-600 dark:text-emerald-400 hover:underline">
                  Endpoints
                </Link>{" "}
      ...
      <section className="space-y-3">
        <div className="flex items-center justify-between">
          <h2 className="flex items-center gap-2 text-sm font-semibold text-zinc-600 dark:text-zinc-300">
            <Activity className="h-4 w-4 text-emerald-600 dark:text-emerald-400" />
            Platform Performance Metrics ({windowId} Window)
          </h2>
          <span className="text-xs text-zinc-600 dark:text-zinc-500">Live statistics computed from ingested telemetry</span>
        </div>
        ...
        {loading && !summary ? (
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 bg-gradient-to-b from-zinc-50/90 dark:from-zinc-900/90 to-white/80 dark:to-zinc-950/80 p-5 shadow-lg ring-1 ring-zinc-950/5 dark:ring-white/[0.03] transition hover:border-zinc-300 dark:hover:border-zinc-700">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <dd className="mt-1 text-3xl font-extrabold tabular-nums tracking-tight text-zinc-900 dark:text-white">
                    {totalReqs.toLocaleString()}
                  </dd>
                </div>
              ...
              <div className="mt-4 space-y-1.5">
                <div className="flex items-center justify-between text-xs font-semibold">
                  <span className="text-emerald-600 dark:text-emerald-400">{successRate.toFixed(1)}% Success</span>
                ...
                <div className="flex items-center justify-between text-[11px] text-zinc-700 dark:text-zinc-400 pt-0.5">
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 bg-gradient-to-b from-zinc-50/90 dark:from-zinc-900/90 to-white/80 dark:to-zinc-950/80 p-5 shadow-lg ring-1 ring-zinc-950/5 dark:ring-white/[0.03] transition hover:border-zinc-300 dark:hover:border-zinc-700">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <dd className="mt-1 text-3xl font-extrabold tabular-nums tracking-tight text-cyan-700 dark:text-cyan-300">
              ...
              <div className="mt-4 pt-2 border-t border-zinc-200/60 dark:border-zinc-800/60 flex items-center justify-between text-xs">
                <span className="text-zinc-700 dark:text-zinc-400">Total User Sessions:</span>
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 bg-gradient-to-b from-zinc-50/90 dark:from-zinc-900/90 to-white/80 dark:to-zinc-950/80 p-5 shadow-lg ring-1 ring-zinc-950/5 dark:ring-white/[0.03] transition hover:border-zinc-300 dark:hover:border-zinc-700">
                ...
                <div>
                  ...
                  <dd
                    className={clsx(
                      ...
                      (summary?.failed_sessions_24h ?? 0) > 0 ? "text-rose-400" : "text-emerald-600 dark:text-emerald-400"
                    )}
                  >
              ...
              <div className="mt-4 pt-2 border-t border-zinc-200/60 dark:border-zinc-800/60 flex items-center justify-between text-xs">
                <span className="text-zinc-700 dark:text-zinc-400">Open Incidents:</span>
                <span
                  className={clsx(
              ...
              <p className="mt-1 text-[11px] text-zinc-700 dark:text-zinc-400 truncate">
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-zinc-200/80 dark:border-zinc-800/80 bg-gradient-to-b from-zinc-50/90 dark:from-zinc-900/90 to-white/80 dark:to-zinc-950/80 p-5 shadow-lg ring-1 ring-zinc-950/5 dark:ring-white/[0.03] transition hover:border-zinc-300 dark:hover:border-zinc-700">
              ...
              <div className="mt-4 flex flex-wrap items-center gap-x-4 gap-y-1.5 text-xs">
                {services.map((svc) => (
                  <div key={svc} className="flex items-center gap-1.5">
                    ...
                    <span className="font-semibold text-zinc-700 dark:text-zinc-200">{svc}:</span>
              ...
              <p className="mt-2 text-[11px] text-zinc-700 dark:text-zinc-400">
                5m Error Rate:{" "}
                {services.map((svc, i) => (
                  <span key={svc}>
      ...
      <section className="space-y-4">
        <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Link
            to="/endpoints"
            className="inline-flex items-center gap-1.5 rounded-xl border border-emerald-500/30 bg-emerald-500/10 px-3 py-1.5 text-xs font-semibold text-emerald-700 dark:text-emerald-300 transition hover:bg-emerald-500/20"
          >
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {(dash?.apis ?? []).map((api) => (
              <ApiMetricCard
                ...
                ping={{ reachable: api.reachable, latencyMs: api.ping_latency_ms }}
              />
            ))}
          </div>
        )}
      ...
      {(summary?.open_incidents ?? 0) > 0 && (
        <section className="rounded-2xl border border-amber-500/30 bg-gradient-to-r from-amber-500/10 via-amber-500/5 to-white dark:to-zinc-950 p-5 shadow-xl">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-amber-500/20 text-amber-700 dark:text-amber-300 ring-1 ring-amber-500/30">
                <AlertTriangle className="h-5 w-5" />
              </div>
              <div>
                <h3 className="text-sm font-bold text-amber-700 dark:text-amber-200">
